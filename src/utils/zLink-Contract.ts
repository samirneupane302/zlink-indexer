...
const ZLINK_CONTRACT_ABI: string[] = [
  ...
  "function transferShieldedNative((uint256[2] pi_a, uint256[2][2] pi_b, uint256[2] pi_c) proof, uint256[50] publicSignals, bytes[20] encryptedUTXOsUpdates) payable returns (bool)",
];
